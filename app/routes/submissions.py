"""Submission routes (middle column question + reference input)."""
...
async def create_submission(
    ...
    # TODO: keyword generation for interactive reader (middle column)
    keywords: list[str] = []
    ...
    submission_read = SubmissionRead(
        ...
        reference_text=created.reference_text,
        keywords=keywords,
    )
...
submissions_router = Router(
    ...
    route_handlers=[create_submission],
    dependencies={
        "chat_session_repo": provide_chat_session_repo_dep,
        "submission_repo": provide_submission_repo_dep,
    },
)
